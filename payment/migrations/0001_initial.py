...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('entry_type', models.CharField(choices=[('PAYMENT', 'Payment'), ('COMMISSION', 'Commission'), ('VENDOR_PAYOUT', 'Vendor Payout'), ('REFUND', 'Refund'), ('ADJUSTMENT', 'Adjustment')], max_length=30)),
                ('amount', models.DecimalField(decimal_places=2, max_digits=12)),
                ('description', models.TextField(blank=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ledger_entries', to='order.order')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='payout_requests', to='order.order')),
                ('payment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='payout_requests', to='payment.payment')),
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['reference'], name='payment_web_referen_56bbc2_idx'), models.Index(fields=['processed'], name='payment_web_process_534837_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='payment',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['status'], name='payment_pay_status_f300b4_idx'),
        ),
        migrations.AddIndex(
            model_name='payoutrequest',
            index=models.Index(fields=['provider_reference'], name='payment_pay_provide_92bebb_idx'),
        ),
        migrations.AddIndex(
            model_name='earning',
            index=models.Index(fields=['status'], name='payment_ear_status_14faf3_idx'),
        ),
        migrations.AddIndex(
            model_name='earning',
            index=models.Index(fields=['merchant_id_snapshot'], name='payment_ear_merchan_7eacbf_idx'),
        ),
